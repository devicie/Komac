...
instances:
  overlay_offset:
    value:
      pe.pe.sections[pe.pe.coff_hdr.number_of_sections - 1].pointer_to_raw_data +
  ...
  overlay:
    ...
    type:
      ...
      cases:
        ...
        '"Inst"': installshield_overlay
        '"ISSe"': installshield_overlay
        _: installscript_overlay
...
types:
  ...
  file_entry_plain:
    seq:
      - id: file_name
        ...
        doc: char file_name[_MAX_PATH] in C
      - id: encoded_flags
        type: u4
      - id: x3
        type: u4
  ...
  installscript_overlay:
    seq:
      - id: num_files
        type: u4
      - id: files
        type: installscript_file
        repeat: expr
        repeat-expr: num_files
  installscript_file:
    seq:
